...
import com.example.demo.uniti.ConnectionHelper;
    ...
    public boolean save(Account account) {
        try {
            ...
            PreparedStatement preparedStatement =
                    connection.prepareStatement("insert into accounts (username, email, password, fullName, phone,birthday, status) values (?,?,?,?,?,?, ?)");
